...
class GameStatus:
    ...
    def get_negamax_scores(self, terminal):
        ...
        # Loops through each row and column all across the board  
    ...
    def get_moves(self):
        """
        YOUR CODE HERE TO ADD ALL THE NON EMPTY CELLS TO MOVES VARIABLES AND RETURN IT TO BE USED BY YOUR
